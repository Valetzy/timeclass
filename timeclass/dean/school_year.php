                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Add School Year!</h1>
                                </div>
                                <form action="add_school_year.php" class="user" method="post">
                                    <div class="form-group row d-flex justify-content-center">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control form-control-user mb-3" 
                                                name="start_year" placeholder="Start Year" min="1900" max="2100" 
                                                oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);">

                                            <input type="number" class="form-control form-control-user mb-3" 
                                                name="end_year" placeholder="End Year" min="1900" max="2100" 
                                                oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);">
                                        </div>
                                    </div>
