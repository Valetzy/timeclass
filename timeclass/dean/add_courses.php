                                ...
                                <form action="../controller/add_course.php" class="user" method="post">
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user mb-3" name="courses" id="exampleCourse" placeholder="Course">
                                            <input type="number" class="form-control form-control-user mb-3" name="year_lvl" id="exampleYearlevel" placeholder="Year Level">
                                            <input type="text" class="form-control form-control-user mb-3" name="section" id="exampleSection" placeholder="Section">
                                            <div class="form-control-user mb-3 col-sm-6" style="padding: 20px; border-radius: 10px;">
                                                <?php
