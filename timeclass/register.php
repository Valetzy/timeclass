                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="controller/registration.php">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" name="contact" class="form-control form-control-user" id="exampleContact"
                                            placeholder="Contact Number" required >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="department" class="form-control form-control-user" id="exampleDepartment"
                                            placeholder="Department"  required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" name="address" class="form-control form-control-user" id="exampleAddress"
