    ...
    <li class="nav-item">
        ...
        <div id="subject" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="department.php">Department Lists</a>
                <a class="collapse-item" href="subject.php">Subject Lists</a>
                <a class="collapse-item" href="courses.php">Course Lists</a>
            </div>
        </div>
    </li>
