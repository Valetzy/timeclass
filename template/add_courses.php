            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Course Lists</h1>
                    </div>
                            ...
                            <form action="../controller/add_course.php" class="user" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user mb-3" name="courses" id="exampleCourse"
                                            placeholder="Course">
                                            <input type="number" class="form-control form-control-user mb-3" name="year_lvl" id="exampleYearlevel"
                                            placeholder="Year Level">
                                            <input type="text" class="form-control form-control-user mb-3" name="section" id="exampleSection"
                                            placeholder="Section">
